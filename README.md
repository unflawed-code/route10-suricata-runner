...
[![SLSA Build L2](https://img.shields.io/badge/SLSA%20Build-L2-blue)](SUPPLY_CHAIN.md)
...
Release artifacts include SHA256 checksums and GitHub artifact attestations. See [SUPPLY_CHAIN.md](SUPPLY_CHAIN.md) for verification steps.
